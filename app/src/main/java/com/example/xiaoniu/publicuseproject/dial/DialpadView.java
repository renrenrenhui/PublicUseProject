...
public class DialpadView extends LinearLayout {
    ...
    public DialpadView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIsRtl = ViewUtil.getLayoutDirection(context) ==
    ...
    protected void onFinishInflate() {
        ...
        mDelete = (ImageView) findViewById(R.id.deleteButton);
...
//                    (RippleDrawable) getContext().getDrawable(R.drawable.btn_dialpad_key);
            /*final RippleDrawable rippleBackground =
                    (RippleDrawable) getContext().getResources().getDrawable(R.drawable.btn_dialpad_key);*/
    ...
    public void animateShow() {
        ...
        for (int i = 0; i < mButtonIds.length; i++) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                Interpolator EASE_OUT_EASE_IN = new PathInterpolator(0.4f, 0, 0.2f, 1);
