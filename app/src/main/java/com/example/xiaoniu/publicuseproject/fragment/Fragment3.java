...
public class Fragment3 extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initResource() {
        Glide.with(getActivity()).load("http://img.my.csdn.net/uploads/201407/26/1406383264_3954.jpg").listener(new RequestListener<String, GlideDrawable>() {
            @Override
